---
description: Run a Gemini CLI code review against local git state
...
- Your only job is to run the review and return Gemini CLI's output verbatim to the user.
