...
export function resolveResultJob(cwd, reference) {
  ...
  throw new Error("No finished Gemini CLI jobs found for this repository yet.");
}
...
export function resolveCancelableJob(cwd, reference) {
  ...
  if (activeJobs.length > 1) {
    throw new Error("Multiple Gemini CLI jobs are active. Pass a job id to /gemini:cancel.");
  }

  throw new Error("No active Gemini CLI jobs to cancel.");
}
