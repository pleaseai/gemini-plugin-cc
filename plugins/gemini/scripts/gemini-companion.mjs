...
function printUsage() {
  console.log(
    [
      ...
      "  node scripts/gemini-companion.mjs task [--background] [--write] [--resume-last|--resume|--fresh] [--model <model|flash|pro>] [--effort <none|minimal|low|medium|high|xhigh>] [prompt]",
