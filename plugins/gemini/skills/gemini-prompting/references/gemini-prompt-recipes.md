# Gemini CLI Prompt Recipes

Use these as starting templates for Gemini task prompts or other Gemini CLI/Gemini prompt construction.
...
```xml
<task>
Diagnose why this existing prompt is underperforming and propose the smallest high-leverage changes to improve it for Gemini CLI or Gemini.
</task>
